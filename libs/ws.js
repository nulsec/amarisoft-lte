 ...
 * WebSocket example version 2024-12-13
 */
...
if (!scriptMode)
    console.log("WebSocket remote API tool version 2024-12-13, Copyright (C) 2012-2024 Amarisoft");
...
ws.on('text', function (msg) {
    ...
    if (msg0) {
        ...
        case 'authenticate':
            ...
            return;
        case 'ready':
            Log('### Ready: name=' + msg0.name + ', type=' + msg0.type + ', version=' + msg0.version);
            Start();
            return;
        case 'error':
...
// For plugin
global.sendMsg = function (msg, cb)
{
    var id = "id#" + (++msg_id);
    cmdList.push({msg: msg, type: 'msg', cb});
    return id;
}
